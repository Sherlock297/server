...
echo -e "\e[30;48;5;82mPLEASE WAIT SCRITI IS RUNNING........!It will take some time depending on the domains provided by you.>

printf "\n\n"

echo -e "To see VERBOSE output please run the command as './server.sh -v'"

for urls in  $(cat domains.txt);
        do echo -e "\e[38;5;47m $urls\e[0m"
                 curl -k $1 -s -I $urls | grep 'Server:\|X-Powered-By:'
